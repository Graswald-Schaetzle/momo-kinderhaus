...
import eigenstaendigkeitVideo from "@/assets/film-eigenstaendigkeit-portrait-6.mp4.asset.json";
...
const sections: Section[] = [
  ...
  },
  {
    ...
    alt: "Filmaufnahme: Kinderhände stapeln Bauklötze, der Turm bleibt stehen",
